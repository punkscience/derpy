...
$packageName    = 'derpy'
$url64          = 'https://github.com/Punk-Science-Studios-Inc/derpy/releases/download/v1.0.0/derpy_1.0.0_windows_amd64.zip'
$url64arm       = 'https://github.com/Punk-Science-Studios-Inc/derpy/releases/download/v1.0.0/derpy_1.0.0_windows_arm64.zip'
